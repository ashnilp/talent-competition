    ...
    public class ListingController : Controller
    {
        ...
        public async Task<IActionResult> GetSortedEmployerJobs(int activePage, string sortbyDate, bool showActive, bool showClosed, bool showDraft, bool showExpired, bool showUnexpired, string employerId = null, int limit = 6)
        {
            try
            {
                ...
                List<mongoDB> mongos = new List<mongoDB>
                {
                    new mongoDB { _id="1", EmployeeID = "5cab665a805aa43c2008ce08", Title = "Software Developer", Description = "Software Developer for MVP Studio", Summary="C#, MVC ", Location="Hamilton, New Zealand", ExpiryDate="26/04/2019"},
                    new mongoDB { _id="2", EmployeeID = "5cab665a805aa43c2008ce08", Title="Carpenter", Description="Hi I am second", Summary="Capentary work", Location="Hamilton, New Zealand", ExpiryDate="29/04/2019"}
                };

                
                return Json(new { Success = true, myJobs = mongos, TotalCount = mongos.Count() });
